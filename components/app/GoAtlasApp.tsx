...
import { SidebarNav, type NavTab } from '@/components/shared/SidebarNav';
...
export default function GoAtlasApp() {
  ...
  return (
    <div className="h-screen max-h-screen bg-[#FAFAFA] flex flex-col md:flex-row font-sans text-[#111111] antialiased selection:bg-blue-100 selection:text-blue-900 w-full max-w-full overflow-hidden">
      ...
      {/* Main App Container */}
      <div className="flex-1 flex flex-col min-w-0 h-screen max-h-screen overflow-y-auto overflow-x-hidden md:ml-64 max-w-full relative">
        {/* Top Header */}
        <HeaderNav
          activeTab={activeTab}
          onSelectTab={(tab) => {
